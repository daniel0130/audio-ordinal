...
//     control.max = "100";
//     control.step = "1";
//     control.value = "100"; // Set to max by default
...
//     // Set the control's initial value based on the current gainNode's setting
//     control.value = initialVolume * 100; // Assuming volume is 0-1 and needs scaling to 0-100

//     const valueDisplay = document.createElement('span');
//     valueDisplay.textContent = initialVolume.toFixed(2);
  
//     control.oninput = function() {
//       let volumeValue = parseFloat(control.value) / 100;
//       valueDisplay.textContent = volumeValue.toFixed(2);
//       onChangeCallback(channelIndex, volumeValue, stepIndex);
//     };
