...
function preprocessAndSchedulePlayback() {
    ...
    // Mark as ready to play after preprocessing is done
    isReadyToPlay = true;
...
function playSequenceStep(scheduledTime) {
    // Combined check for sequence data readiness and availability
...
async function togglePlayback() {
    ...
    if (isPlaying) {
        ...
        resetPlayback();
        // Directly reset cci2 without dispatching the custom event
        if (typeof cci2 !== 'undefined' && typeof initialCCI2 !== 'undefined') {
            ...
            // Ensure the visualizer is updated to reflect this change
